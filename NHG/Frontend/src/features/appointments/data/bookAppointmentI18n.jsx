...
export const translations = {
  en: {
    ...
    schedule: {
      ...
      dateLockedHint: "Fixed to your selected clinic session date.",
      pickClinicFirst: "Select a clinic session above first.",
  ...
  si: {
    ...
    schedule: {
      ...
      dateLockedHint: "තෝරාගත් සායන වේලාවේ දිනයට අනුව සකසා ඇත.",
      pickClinicFirst: "පළමුව ඉහත සායනයක් තෝරන්න.",
      sessionWindow: "සායන වේලාව",
      time: "කැමති වේලාව",
  ...
  ta: {
    ...
    schedule: {
      ...
      dateLockedHint: "தேர்ந்தெடுத்த சிகிச்சை நேரத்தின் தேதிக்கு நிர்ணயிக்கப்பட்டது.",
      pickClinicFirst: "முதலில் மேலே ஒரு சிகிச்சை நேரத்தைத் தேர்ந்தெடுக்கவும்.",
      sessionWindow: "சிகிச்சை நேரம்",
